...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    Watch = __webpack_require__(159);
	
	document.addEventListener("DOMContentLoaded", function () {
	    ReactDOM.render(React.createElement(Watch, null), document.getElementById('root'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Buttons = __webpack_require__(161);
	var Display = __webpack_require__(160);
	var Splits = __webpack_require__(162);
	...
	var Watch = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Buttons, { button1Callback: this.button1Pressed, button2Callback: this.button2Pressed, running: this.state.running }),
	      React.createElement(Display, { elapsed: this.state.elapsed }),
	      React.createElement(Splits, { splits: this.state.splits })
	    );
	  }
	});
	...
	var Buttons = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "button",
	        { onClick: this.props.button1Callback },
	        btn1Text
	      ),
	      React.createElement(
	        "button",
	        { onClick: this.props.button2Callback },
	        btn2Text
	      )
	    );
	  }
